...
<head>
    ...
    <style>
        ...
        /* Hero Section */
        .hero-section {
            background: linear-gradient(135deg, #4274BA 0%, #2c3e50 100%);
            color: white;
        ...
        .hero-section::before {
            ...
            background: url('https://media.istockphoto.com/id/1146014337/photo/digital-landscape.jpg?s=612x612&w=0&k=20&c=nru7BN3-k5aMV0Tnd-B4O2ksCfvLGdZz8orLnrQKH1Q=') no-repeat center center;
...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid">
                    <a class="navbar-brand logo" href="#">
                        <img src="{{asset('own_assets/images/banner.png')}}" alt="" width="75px" srcset="">
                    </a>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 hero-content">
                    <h1 class="hero-title">FORUM REKTOR SELURUH PTKIN</h1>
                    <p class="hero-subtitle">Grand City Hall Medan</p>
                    <p class="hero-subtitle">30 Januari 2026</p>
    ...
    <footer class="footer">
        <div class="container">
            <p>FORUM REKTOR SELURUH PTKIN</p>
        </div>
    </footer>
